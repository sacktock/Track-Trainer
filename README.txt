...
To run the project, 'git clone' this repository to a suitable directory. From android studio 'file -> open project' and then navigate to this repository and open with 'Track Trainer.iml'.
